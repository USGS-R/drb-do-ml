...
def plot_obs_preds(pred_file, obs_file, site_id, start_date, end_date, outfile=None):
    ...
    sns.relplot(x = "date", y="value", row="variable", hue="type", data=df_comb, kind='line', height=1, aspect=5, facet_kws={'sharey': False})
    if outfile:
