...
For NWIS, there were `r length(site_list$site_id[grepl("NWIS",site_list$data_src_combined)])` continuous DO sites within the lower DRB. Some of those report the instantaneous values, but for older data only daily values were available. Here's a breakdown of the sites/samples:
...
site_list %>% 
  mutate(data_src_simple = as.factor(case_when(data_src_combined == "NWIS_daily/Harmonized_WQP_data" ~ "NWIS-daily",
                           data_src_combined == "NWIS_instantaneous/Harmonized_WQP_data" ~ "NWIS-instantaneous",
                           data_src_combined == "Harmonized_WQP_data" ~ "WQP",
                           data_src_combined == "NWIS_instantaneous" ~ "NWIS-instantaneous",
                           data_src_combined == "NWIS_daily" ~ "NWIS-daily"))) %>%
